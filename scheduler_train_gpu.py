...
parser.add_argument('--total_epoch', default=35, type=int, help='Number of epoch')
...
parser.add_argument('--stepvalues', default='70000,90000', type=str, help='iter number when learning rate to be dropped')
