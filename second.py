...
def main():
    ...
    parser.add_argument('--resume', default="/data4/lilin/my_code/realtime/realtime-lstm/saveucf24/ucf101_CONV-SSD-ucf24-rgb-bs-64-vgg16-lr-00050_second_epoch_1_checkpoint.pth.tar",
